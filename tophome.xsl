				...
				<xsl:choose>
					...
					<xsl:choose>
			            ...
			            <div class="banner_text">
			                <h2 class="pagetitle"><xsl:copy-of select="document/title/node()" /></h2>
			                <div class="banner_caption" role="complementary">
			                   <xsl:copy-of select="document/maincontent/banner/banner_caption/node()" />
			                </div>
			            </div>

			            <div class="banner_image" role="banner">
			            ...
			            <div>
			                <h2 class="pagetitle"><xsl:copy-of select="document/title/node()" /></h2>
			                <div class="banner_caption" role="complementary" style="background-color: grey; width: 660px;">
			                   <xsl:copy-of select="document/maincontent/banner/banner_caption/node()" />
			                </div>
			            </div>
			            <!-- end Banner Text -->
