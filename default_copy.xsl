...
<xsl:variable name="excludedDir" as="xs:string" select="'_resources,OMNI-ASSETS,includes,_trash,assets,docs,pics,links,OMNI-INF,_configuration,_specialcontent'" />
...
<xsl:template name="quickicons">
	<a href="/mysjsu/" class="tooltip btn_my" title="MySJSU">MySJSU</a> 
	<a href="http://www.sjsuspartans.com/" class="tooltip btn_helmet" title="Spartan Athletics">Spartan Athletics</a> 
	<a href="/alumni-and-community/giving/" class="tooltip btn_heart" title="Give to SJSU">Give to SJSU</a> 
</xsl:template>
...
<xsl:template name="socialmedia">
	...
	<div id="socialicons">
	    <a href="{$ou:twitterAcc}" class="btn_t" title="Twitter">Twitter</a>
	    <a href="{$ou:facebookAcc}" class="btn_f" title="Facebook">Facebook</a>
	    <a href="{$ou:rssAcc}" class="btn_r" title="RSS">RSS</a>
	</div>
</xsl:template>
